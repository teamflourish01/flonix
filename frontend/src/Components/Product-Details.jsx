              ...
              <div className="all-page-padding">
                <div className="product-d-flex">
                    ...
                    <ReactImageMagnify
                      {...{
                        smallImage: {
                          ...
                          alt:
                            product.image_alt[selectedImageIndex] ||
                            product.name,
                        },
                        largeImage: {
                          src: `${apiUrl}/product/${product?.image[selectedImageIndex]}`,
                  ...
                  <div className="Detail-content">
                    ...
                    {product.mark &&
                      product.mark_text &&
                      product.mark.length > 0 &&
                      product.mark_text.length > 0 && (
                            ...
                            {product.mark.map((mark, index) => (
                              <div className="firsticone" key={index}>
                                <div className="iconeimages">
                                  <img
                                    src={`${apiUrl}/product/${mark}`}
                                    alt={product.mark_text[index]}
                                  />
                                </div>
                    ...
                    >
                      {relatedProducts.map((relatedProduct) => (
                        ...
                        >
                          <div className="card">
                            <img
                              src={`${apiUrl}/product/${relatedProduct.image[0]}`}
                              alt={relatedProduct.image_alt[0]}
                            />
